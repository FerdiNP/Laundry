        ...
        Login = event => {
            ...
            .then(response => {
                ...
                if (this.state.logged){
                    ...
                    this.props.history.push("/kasir/dashboard")
                }else{
                      ...
                      <div className="col-lg-12">
                        <div className="p-5">
                          <div className="text-center">
                            <h1 className="h4 text-gray-900 mb-4">Login Kasir</h1>
                          </div>
                          <form onSubmit={ev => this.Login(ev)} className="user">
                            ...
                            <div class="btn-group" role="group" aria-label="Basic example">
                              ...
                              <a class="btn btn-outline-danger active"> Login Kasir </a>
                              <a class="btn btn-outline-warning" href="/owner"> Login Owner </a>
                            </div>
                            </center>
                          </form>
                          <hr/>
